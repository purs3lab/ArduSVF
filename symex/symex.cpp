...
//		print_classes(*ll_mod);
		...
		string cmd = "klee -disable-verify=true --write-smt2s -solver-backend=z3 --check-div-zero=false --check-overshift=false --optimize=false --search=lloop --libc=baremetal --entry-point=" + entry_point +" --allocate-determ --allocate-determ-start-address=0x10000 symex_temp.bc";
